    ...
    >
      ...
      <g id="Variations">
        <g id="Bean_Pack" data-name="Bean Pack">
          ...
          <path
            className="cls-3"
            d="m13.05,0h-7.22c-1.11,0-2.01.9-2.01,2.01v3.69h11.23v-3.69c0-1.11-.9-2.01-2-2.01Zm1,4.7H4.82v-2.69c0-.56.45-1.01,1.01-1.01h7.22c.55,0,1,.45,1,1.01v2.69Z"
          />
          <g>
            <path
              className="cls-3"
              d="m10.08,9.9c.24,0,.48.05.69.16,1,.52,1.22,2.1.48,3.53-.58,1.13-1.57,1.83-2.46,1.83-.24,0-.48-.05-.69-.16-1-.52-1.22-2.1-.48-3.53.58-1.13,1.57-1.83,2.46-1.83m0-1h0c-1.29,0-2.61.93-3.35,2.37-1.01,1.95-.6,4.1.91,4.88.35.18.74.27,1.15.27,1.29,0,2.61-.93,3.35-2.37.45-.87.63-1.83.51-2.7-.13-.99-.65-1.78-1.43-2.18-.35-.18-.74-.27-1.15-.27h0Z"
            />
            <path
              className="cls-4"
              d="m10.87,9.5c.13,1.06-.1,1.73-.35,2.16-.73,1.26-2.13,1.29-2.64,2.52-.24.58-.17,1.16-.07,1.56"
            />
          </g>
        </g>
      </g>
