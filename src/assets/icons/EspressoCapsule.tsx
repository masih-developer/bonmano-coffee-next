    ...
    >
      ...
      <g id="Variations">
        <g id="Capsule">
          <path
            className="cls-1"
            d="m2,2.09l.19,1c.24-.31.75-.67,1.51-1h-1.7Zm14.46,2.76l-.21,1.16-1.93,10.38c-.13.69-.59,1.25-1.23,1.51l-2.36.96c-.23.09-.48.14-.73.14s-.5-.05-.74-.14l-2.36-.96c-.64-.26-1.1-.83-1.23-1.51l-.43-2.28c-.05-.23-.25-.4-.49-.4-.03,0-.07,0-.1.01-.22.05-.4.24-.4.49l.03.18s.01.01.01.02l.4,2.16c.19,1.02.88,1.87,1.83,2.26l2.36.95c.36.15.74.22,1.12.22s.75-.07,1.11-.22l2.36-.95c.95-.39,1.64-1.24,1.83-2.26l2.06-11.07.26-1.39c-.26.25-.65.5-1.16.74Zm-12.14,4.28s-.01-.02-.01-.04l-.57-3.08-.21-1.17c-.51-.23-.89-.48-1.15-.73l.25,1.39.73,3.89c.05.23.25.4.49.4.04,0,.07,0,.11-.01.22-.05.39-.25.39-.49v-.02l-.03-.14Zm11.98-7.04c.76.33,1.27.69,1.51,1l.19-1h-1.7Z"
          />
          <path
            className="cls-3"
